...
class MyGUI(QMainWindow):
    def __init__(self):
        ...
        uic.loadUi(
            "C:\Users\ikbal\OneDrive\Desktop\Python_photo")
        self.show()
    ...
    def mousePressEvent(self, event: QMouseEvent):
        try:
            ...
            if event.button() == Qt.LeftButton:
                self._x = event.globalX() - 250
                self._y = event.globalY() - 125
            print("Clicked at coordinates:", self._x, self._y)
            cv2.putText(self.modified_image, text, (self._x, self._y),
                        fontface, font_size, (red, green, blue), 2)
